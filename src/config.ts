...
// where needed (agent-runner.ts) to avoid leaking to child processes.
...
// Mount security: allowlist stored OUTSIDE project root for additional directory validation
